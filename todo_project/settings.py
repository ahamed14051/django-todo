...
SECRET_KEY = 'django-insecure-)jex^1(y9byad15s@tk87cxy%8-%-_lq80&pkhep78r+_*c==-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['todo14051.herokuapp.com']
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',     # Replace with your database host (default: 'localhost')
